...
const songsData = [
  {
    ...
    title: "AURA",
    artist: "Ogryzek",
    desc: "Gaya musiknya menggabungkan elemen phonk gelap, funk Brasil, dan elektronik, menciptakan suasana atmosferik yang melankolis namun memikat—ciri khas gaya Ogryzek.",
  ...
  },
  {
    ...
    title: "X-PRIME",
    artist: "Dj samir",
    desc: "Termasuk dalam genre phonk, dengan tekstur gelap, atmosferik, dan ritme minimalis yang mendekati funk urbano atau funk automotivo, namun tetap mempertahankan nuansa hip-hop dan trap yang halus",
  ...
  },
  {
    ...
    artist: "akiaura",
    desc: "Lagu ini merupakan kolaborasi antara Akiaura, LONOWN, dan STM, dan termasuk sebagai track ketiga dari album Ketamine Girl. Dirilis pada 30 Juni 2023 di bawah label virtual memory404.",
  ...
  },
  {
    ...
    title: "SLAY!",
    artist: "Eternxlkz",
    desc: "Tenang tapi gelap, cocok didengarkan ketika menyendiri, berkendara malam, atau berkhayal. Bass dalamnya bikin suasana terasa misterius tapi tetap santai.",
  ...
  },
  {
    ...
    artist: "Clovis Reyes",
    desc: "Lagu-lagu di EP ini menghadirkan nuansa futuristik, melankolis, dan memikat, dengan unsur gelap yang terasa kuat. Beat yang halus dan pad sintetis menciptakan atmosfer yang terkesan introspektif dan sedikit nostalgia.",
  ...
  },
  {
    ...
    desc: "Lagu ini menyajikan atmosfer energetik, penuh semangat, dengan sentuhan kegilaan ritmis khas EDM.",
  ...
  },
  {
    ...
    artist: "mgd",
    desc: " Gaya musiknya ceria, upbeat, dan penuh karakter. Ritme yang 'ngempos', beat yang cepat dan ritmis, menciptakan suasana yang mengajak pendengar untuk ikut bergoyang atau tersenyum.",
  ...
  },
  {
    ...
    title: "Avangard",
    artist: "slxughter",
    desc: "Atmosfer terasa gelap, intens, dan ritmis, dengan groove yang memikat—karakteristik phonk yang kuat dipadukan dengan vibe Latin funk, menciptakan nuansa urban dan sedikit futuristik.",
  ...
  },
  {
    ...
    title: "Manasha",
    artist: "Ashreveal",
    desc: "Memancarkan vibe gelap, intens, dan penuh energi bawah tanah—membawa pendengar ke suasana urban yang gritty tapi menarik.",
